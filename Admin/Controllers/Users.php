...
class Users extends BaseController
{
    ...
    public function index()
    {
        ...
        return view ('\Admin\Views\Users\index', ['users'=>$users, "pager"=>$this->model->pager]);
    }
    ...
    public function groups($id){
        ...
        if($this->request->is("post")){
            ...
            return redirect()->to("/admin/users/$id")->with("message","user group saved succesfully");
        }
    ...
    public function permissions($id){
        ...
        if($this->request->is("post")){
            ...
            return redirect()->to("/admin/users/$id")->with("message","user permissions saved succesfully");
        }

        return view("Admin\Views\Users\permissions",["user"=>$user]);
    }

    public function getUserOr404($id) : User
    {
